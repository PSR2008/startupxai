...
const navGroups = [
  {
    ...
    items: [
      ...
      { label: "Evidence Engine", href: "/evidence-engine", icon: SearchCheck, color: "text-emerald-600", badge: "CORE" },
      ...
      { label: "Competitor Intelligence", href: "/competitor-intelligence", icon: Swords, color: "text-amber-600" },
