...
export default function GrowthEnginePage() {
  ...
  return (
    <div className="p-6 lg:p-8 max-w-6xl mx-auto">
      ...
      <MagicBentoGrid className="mt-6 grid grid-cols-1 sm:grid-cols-3 gap-3" preset="app" glowColor="37, 99, 235" spotlightOpacity={0.07}>
...
function ContextCard({ title, detail }: { icon: React.ReactNode; title: string; detail: string; tone: "blue" | "amber" | "teal" }) {
  return (
