...
export async function POST(request: NextRequest) {
  ...
  try {
    ...
    await saveAnalysis({ sessionId, engineType: "growth", inputData: validation.data as unknown as Record<string, unknown>, outputData: result as unknown as Record<string, unknown>, ipHash });
